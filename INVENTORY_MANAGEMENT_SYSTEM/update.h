	...
	public:
		...
		update(int row,int col)
		{
			...
			if (col == 0) {
				...
				textBox1->Text = Excel->read_data(row, col);
			}
			else if (col == 2) {
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Location = System::Drawing::Point(103, 93);
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(44, 133);
			...
			this->button2->Location = System::Drawing::Point(198, 194);
			...
			this->Name = L"update";
			this->Text = L"UPDATE INFORMATION";
...
private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
	Excel->updateProduct(xrow, xcol, textBox1->Text);
	update::Close();
